...
public class SignTileEntityRenderer extends TileEntityRenderer<SignTileEntity> {
    ...
    private final net.minecraft.client.renderer.tileentity.SignTileEntityRenderer.SignModel model = new net.minecraft.client.renderer.tileentity.SignTileEntityRenderer.SignModel();
