...
public class UtilcraftBiomeFeatures {
    private static final BlockState SAKURA_LEAVES = UtilcraftBlocks.SAKURA_LEAVES.get().defaultBlockState();
    private static final BlockState SAKURA_LOG = UtilcraftBlocks.SAKURA_LOG.get().defaultBlockState();
    private static final BlockState SAKURA_SAPLING = UtilcraftBlocks.SAKURA_SAPLING.get().defaultBlockState();
