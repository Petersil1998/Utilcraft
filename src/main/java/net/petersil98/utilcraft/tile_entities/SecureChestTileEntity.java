...
public class SecureChestTileEntity extends LockableLootTileEntity implements IChestLid, ITickableTileEntity {
    ...
    public static int getPlayersUsing(IBlockReader reader, BlockPos posIn) {
        ...
        if (blockstate.hasTileEntity()) {
            ...
            if (tileentity instanceof SecureChestTileEntity) {
                return ((SecureChestTileEntity)tileentity).numPlayersUsing;
            }
        }
    ...
    public static void swapContents(SecureChestTileEntity chest, SecureChestTileEntity otherChest) {
    ...
    private IItemHandlerModifiable createHandler() {
        ...
        if (!(state.getBlock() instanceof SecureChest)) {
            return new InvWrapper(this);
        }
        IInventory inv = SecureChest.getChestInventory((SecureChest) state.getBlock(), state, getWorld(), getPos(), true);
