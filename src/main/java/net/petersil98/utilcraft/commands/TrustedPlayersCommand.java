...
public class TrustedPlayersCommand {
    ...
    private static void grantTrust(CommandSource source, ServerPlayerEntity affectedPlayer) throws CommandSyntaxException {
        ...
        player.sendMessage(new TranslationTextComponent(String.format("player_trusted.%s.player_added", Main.MOD_ID), affectedPlayer.getName()), Util.DUMMY_UUID);
    }
    ...
    private static void revokeTrust(CommandSource source, PlayerEntity affectedPlayer) throws CommandSyntaxException {
        ...
        player.sendMessage(new TranslationTextComponent(String.format("player_trusted.%s.player_removed", Main.MOD_ID), affectedPlayer.getName()), Util.DUMMY_UUID);
    }
    ...
    private static void sendListOfTrustedPlayers(CommandSource source) throws CommandSyntaxException {
        ...
        source.sendFeedback(new TranslationTextComponent(String.format("player_trusted.%s.list", Main.MOD_ID), String.join(", ", trustedPlayers)), false);
    }
}
