...
public class DisenchantmentTableScreen extends AbstractContainerScreen<DisenchantmentTableContainer> {
    ...
    public DisenchantmentTableScreen(DisenchantmentTableContainer screenContainer, Inventory inv, Component title) {
