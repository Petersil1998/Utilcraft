...
public class EntropyTableScreen extends package-info<EntropyTableContainer> {
    ...
    public EntropyTableScreen(EntropyTableContainer screenContainer, package-info inv, Component title) {
