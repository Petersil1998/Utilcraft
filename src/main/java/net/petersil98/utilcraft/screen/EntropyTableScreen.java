...
public class EntropyTableScreen extends AbstractContainerScreen<EntropyTableContainer> {
    ...
    public EntropyTableScreen(EntropyTableContainer screenContainer, Inventory inv, Component title) {
